...
//     * 访问支付宝网关
//     */
//    private void requestZhifubao(final Context cx,
...
//        RequestParams sParaTemp = new RequestParams();
//
//        sParaTemp.put("service", "alipay.wap.create.direct.pay.by.user");
//        sParaTemp.put("partner", "123");
//        sParaTemp.put("seller_id", "2345");
//        sParaTemp.put("_input_charset", "utf-8");
//        sParaTemp.put("payment_type", "1");
//        sParaTemp.put("notify_url", "");
//        sParaTemp.put("return_url", "");
//        sParaTemp.put("out_trade_no", "12345678");
//        sParaTemp.put("subject", "沙坡头门票");
//        sParaTemp.put("total_fee", "0.1");
//        sParaTemp.put("show_url", "");
//        sParaTemp.put("body", "");
//        sParaTemp.put("it_b_pay", "1m");
//        sParaTemp.put("extern_token", "");
//
//        client.post(url, sParaTemp, new TextHttpResponseHandler() {
//
//            @Override
//            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
//                SafeHandler.onFailure(handler, ErrorType.errorMessage(cx, ErrorType.ErrorGetNotificationFailure));
//            }
//
//            @Override
...
//                    String errcode = jsonObject.getString("error_code");
...
//    }
    ...
    public void pay(View v) {
        ...
        Runnable payRunnable = new Runnable() {
            ...
            public void run() {
                // 构造PayTask 对象
                PayTask alipay = new PayTask(Layoutonline_Payment_Activity.this);
                // 调用支付接口，获取支付结果
