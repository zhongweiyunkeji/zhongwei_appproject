...
import com.cdhxqh.travel_ticket_app.ui.activity.CommonContactActivity;
...
public class UserSetingAdapter extends RecyclerView.Adapter<UserSetingAdapter.ViewHolder> {
    ...
    int[] images = { R.drawable.ic_menu_map,R.drawable.ic_menu_users, R.drawable.ic_menu_bill, R.drawable.ic_menu_seting, R.drawable.ic_menu_logo};
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        else if("常用旅客信息".equals(names.get(a))){
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
